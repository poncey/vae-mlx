# Modified by (Yuxuan Pang) on Dec 17th, 2023.
# Changes made: Add Fashion MNIST data support.
# Original code copyright © 2023 Apple Inc.
...
# def batch_resize(image_array: np.ndarray):
#     with concurrent.futures.ThreadPoolExecutor() as executor:
#         resized_array = list(executor.map(resize_image, image_array))  
